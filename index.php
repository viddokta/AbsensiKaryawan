          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title">Anggota Kelompok</h3>
                <br>
                <p class="card-feature__subtitle">David Dwi Oktavianus  </p>
                <p class="card-feature__subtitle">Novandi Rio Wicaksono  </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <br>
                <p class="card-feature__subtitle">0813-9822-1795</p>
                <p class="card-feature__subtitle">0821-1042-9753</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <br>
                <p class="card-feature__subtitle">@vidd.okt</p>
                <p class="card-feature__subtitle">@gitshii</p>
              </div>
            </div>
          </div>
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Kelompok 1 All rights reserved
