                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <strong class="col-md-12" style="margin-top: 5rem;">Selamat datang admin PT. BINAYASA PUTRABATARA</strong>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2024 Kelompok 1. All rights reserved.</p>
                                </div>
                            </div>
                        </div>
                    </div>
